    ...
    with open("b085587.txt", "w") as f:
        for n in range(1, 1000 + 1):    
            ...
            if cycle_length != cycle_length_heuristic:
                print(f"The maximum cycle length for rule 90 of width {n} is {cycle_length} (differs from the initial heuristic by a factor of {cycle_length_heuristic // cycle_length})")
            else:
                print(f"The maximum cycle length for rule 90 of width {n} is {cycle_length}.")
